...
public class LIMenu extends RecipeBookMenu<CraftingInput, CraftingRecipe> {
    ...
    public LIMenu(int id, Inventory playerInv) {
        ...
        this.backing = new CombinedInventoryHandler(playerInv, LIAttachments.extended(owner));
    ...
    public boolean recipeMatches(RecipeHolder<CraftingRecipe> recipe) {
        return recipe.value().matches(craftSlots.asCraftInput(), owner.level());
    }
    ...
    private boolean tryEquip(ItemStack stack) {
        EquipmentSlot target = owner.getEquipmentSlotForItem(stack);
