...
public final class CreativeTabStrip {
    ...
    private void drawTab(GuiGraphics g, Font font, CreativeModeTab tab, int leftPos, int topPos,
        ...
        String prefix = top ? "container/creative_inventory/tab_top_" : "container/creative_inventory/tab_bottom_";
        String state = selected ? "selected_" : "unselected_";
        ResourceLocation sprite = ResourceLocation.withDefaultNamespace(prefix + state + (page.getColumn(tab) + 1));

        g.blitSprite(sprite, x, y, TAB_W, TAB_H);
