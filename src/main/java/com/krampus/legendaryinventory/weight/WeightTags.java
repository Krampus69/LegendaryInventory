...
public final class WeightTags {
    ...
    public static final TagKey<Item> NO_WEIGHT_FLASH = TagKey.create(
        ...
        ResourceLocation.fromNamespaceAndPath(LegendaryInventory.MODID, "no_weight_flash")
    );

    public static final TagKey<EntityType<?>> BLOCKED_MOUNTS = TagKey.create(
        BuiltInRegistries.ENTITY_TYPE.key(),
        ResourceLocation.fromNamespaceAndPath(LegendaryInventory.MODID, "blocked_mounts")
    );

    public static final TagKey<EntityType<?>> FREE_MOUNTS = TagKey.create(
        BuiltInRegistries.ENTITY_TYPE.key(),
        ResourceLocation.fromNamespaceAndPath(LegendaryInventory.MODID, "free_mounts")
    );
